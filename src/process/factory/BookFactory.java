...
public class BookFactory {
	 ...
	 */
	public static Book createBook(String csvSplit[]) throws IllegalArgumentException, IndexOutOfBoundsException {
		...
		return new Book(titleString, authorString, category, keywords, descriptionString, isBorrowed, borrowerString,
				borrowDateString);
	}
}
