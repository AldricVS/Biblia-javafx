...
public class AlertHelper {
	 ...
	 * @param header  the header of the pop-up window (it will be dispalyed bigger
	 *                than content)
	...
	/**
	 * Show an alert which requires the user to choose an answer among "oui", "non"
	 * or "anuler"
	 * 
	 * @param title   the title of the pop-up window
	 * @param header  the header of the pop-up window (it will be dispalyed bigger
	 *                than content)
	 * @param content the content of the window.
	 * @return an integer which represents the answer of the user.
	 *         <p>
	...
	/**
	 * Show an alert which requires the user to choose an answer among "oui" or
	 * "non"
	 * 
	 * @param title   the title of the pop-up window
	 * @param header  the header of the pop-up window (it will be dispalyed bigger
	 ...
	 * 
	 * @param title       the title of the pop-up window
	 * @param header      the header of the pop-up window (it will be dispalyed
	 *                    bigger than content)
	 * @param content     the content of the window.
	 * @param oldCategory the old category
	 * @return the category the user choose, or {@code null} if no category choosen.
	 */
	public static Categories showCategorySelectionDialog(String title, String header, String content,
	...
	/**
	 * Ask the user to choose in a combo box a specified selection of strings
	 * 
	 * @param title   the title of the pop-up window
	 * @param header  the header of the pop-up window (it will be dispalyed bigger
	 *                than content)
	 * @param content the content of the window.
	 * @param choices the arrayList containg Strings that can be choosen by the user
	 * @return the string chosen by the user or null if no one is selected
	 */
	public static String showStringSelectionDialog(String title, String header, String content,
	...
	/**
	 * Show to user a dialog permitting to chose a letter from the alphabet
	 * 
	 * @param title   the title of the pop-up window
	 * @param header  the header of the pop-up window (it will be dispalyed bigger
	 *                than content)
	 * @param content the content of the window.
	 * @return the letter user chose, or Character.MIN_VALUE else;
	 */
	public static char showAlphabetSelectionDialog(String title, String header, String content) {
		// Get all letters from the alphabet
		...
		ChoiceDialog<Character> choiceDialog = new ChoiceDialog<>(null, chars);
		choiceDialog.setTitle(title);
		choiceDialog.setHeaderText(header);
		choiceDialog.setContentText(content);

		Optional<Character> answer = choiceDialog.showAndWait();
		if (answer.isPresent()) {
			return answer.get();
		} else {
